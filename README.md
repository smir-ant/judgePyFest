...
- <code>potok05.xlsx</code> – отчёт 'Решения учащихся' потока 0.5 (ЭКСПОРТ СРАЗУ ПОСЛЕ ИХ ПОТОКА);
- <code>potok1.xlsx</code> – отчёт 'Решения учащихся' ПЕРВОГО потока;
- <code>potok2.xlsx</code> - отчёт 'Решения учащихся' ВТОРОГО потока;\n\n" +

### ❗"Названия таблиц ВАЖНЫ ❗

> Чтобы оно отработало нужно запустить <code>auto.py</code>
